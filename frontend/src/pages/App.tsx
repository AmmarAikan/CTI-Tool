            ...
            <Routes>
              ...
              <Route element={<ProtectedRoute />}>
                <Route element={<Layout />}>
                  ...
                  <Route path="/intelligence/attack" element={<AttackPage />} />
                  <Route path="/intelligence/correlations" element={<CorrelationsPage />} />
                  <Route path="/intelligence/outliers" element={<OutliersPage />} />
                  <Route path="/processing-center" element={<ProcessingCenter />} />
                  <Route path="/analysis" element={<AnalysisPage />} />
                  <Route path="/misp" element={<MISPPage />} />
