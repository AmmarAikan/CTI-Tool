...
export function ThemeToggle() {
  ...
  return <button className="theme-toggle" type="button" onClick={toggle} aria-pressed={isLight} aria-label={isLight ? t('themeDark') : t('themeLight')} title={isLight ? t('dark') : t('light')}>
