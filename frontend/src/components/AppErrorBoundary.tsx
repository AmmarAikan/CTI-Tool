...
function FatalState() { const { t } = useI18n(); return <main className="fatal-state" role="alert"><strong>{t('fatalTitle')}</strong><p>{t('fatalHint')}</p><a className="button button-primary" href="/dashboard">{t('backDashboard')}</a></main>; }
