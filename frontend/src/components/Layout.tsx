...
const groups: NavGroup[] = [
  ...
  { label: 'الاستخبارات والتحليل', accent: 'analysis', links: [{ to: '/intelligence', label: 'نظرة عامة', icon: icons.intel }, { to: '/intelligence/events', label: 'الأحداث', icon: icons.review }, { to: '/intelligence/indicators', label: 'المؤشرات', icon: icons.source }, { to: '/intelligence/correlations', label: 'الارتباطات', icon: icons.link }, { to: '/intelligence/outliers', label: 'القيم الشاذة', icon: icons.analysis }, { to: '/analysis', label: 'عمليات التحليل', icon: icons.analysis }, { to: '/misp', label: 'MISP', icon: icons.misp }] },
