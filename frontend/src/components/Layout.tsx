...
const groups: NavGroup[] = [
  ...
  { label: 'المصادر الخارجية', accent: 'external', links: [{ to: '/external-sources', label: 'المصادر', icon: icons.source }, { to: '/manual', label: 'رابط يدوي', icon: icons.link, analystOnly: true }, { to: '/dark-web', label: 'مراقبة الدارك ويب', icon: icons.shield }, { to: '/jobs', label: 'الوظائف', icon: icons.jobs }, { to: '/reviews', label: 'المراجعات', icon: icons.review }, { to: '/exports', label: 'التصديرات', icon: icons.export }] },
