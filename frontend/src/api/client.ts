...
export interface MISPPreview { event_id: string; title: string; configured: boolean; published: false; distribution: 0; attributes: Array<{ type: string; category: string; value: string; to_ids: boolean }>; included: number; omitted: number; omitted_by_reason: Record<string, number>; }
